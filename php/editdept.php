...
if(isset($_POST['submit'])) {
  ...
  $update = mysqli_query($conn, "UPDATE department_tbl SET dept_name = '$dept' WHERE id = '$id' ");
  ...
  <div class="col-75">
    ...
    <h1 class="dept">Departments</h1>
       ...
       <?php 
        ...
        if(isset($_GET['edit'])){
        $id = $_GET['edit'];
        $query = mysqli_query($conn, "SELECT * FROM `department_tbl` WHERE id = $id");
      ...
      <form action="" method="post">
        ...
        <div class="row">
          <div class="col-50">
            ...
            <label for="dept"><i class="fa-solid fa-building"></i> Edit Department</label>
            <input type="text" id="dept" name="dept" placeholder="ex. Backend developer" value="<?php echo $row['dept_name']?>">
        </div>
