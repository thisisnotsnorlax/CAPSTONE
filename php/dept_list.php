...
if(isset($_GET['delete'])){
  ...
  $delete_query = mysqli_query($conn, "DELETE FROM `department_tbl` WHERE id = $delete_id ") or die('query failed');
    ...
    <div class="container">
        <div class="header">
            <div class="nav">
                ...
                <div class="user">
                    <a href="department.php" class="btn">Add new  </a>
...
<div class="container1">
  <h1 class="h1dept">List of <span>Departments</span></h1>
<table>
  <tr>
    <th>Departments</th>
    <th>Employee List/Action</th>
  </tr>
  ...
  <tr>
    ...
    <td class="btns"><a href="listbasedondept.php?dept=<?php echo $row['dept_name']; ?>">List</a> <a href="dept_list.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('warning! do you want to delete this?')">Delete</a>  <a href="editdept.php?edit=<?php echo $row['id'];?>">Edit</a></td>
  </tr>
  <?php
    }
