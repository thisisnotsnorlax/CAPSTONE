...
if (isset($_POST['submit'])) {
    ...
    else
    {
        ...
        if ($update_query) {
            ...
            echo '<script>alert("Data Updated."); window.location.href = "prof.php";</script>';
        }
    }
}
?>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade active show" id="account-general">
                            ...
                            <form action="prof.php" enctype="multipart/form-data" method="post">
                                ...
                                $query = mysqli_query($conn, "SELECT * FROM `users_tbl` WHERE id = $loggedInuserId");
                        ...
                        <div class="text-right">
                            ...
                            <a href="userdashboard.php" class="btn btn-default" id="cancelButton" >Cancel</a>
                        </div>
                        <!-- FORM-->
                    </form>
