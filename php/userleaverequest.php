    ...
    <div class="container">
        <div class="header">
            <div class="nav">
                ...
                <div class="user">
                    <a href="leave.php" class="btn"> leave  </a>
...
<div class="container1">
  <h1 class="h1dept">Leave <span>History</span></h1>
<table>
  <tr>
  <th>Name</th>
    <th>Email</th>
  ...
  <?php 
    ...
    $query = "SELECT * FROM leave_tbl WHERE email = '$email' ";
    $result = $conn->query($query);
    if(!$result) {
      die($conn->error);
    }
  ...
  <td><?php echo $row['name'];?> </td>
    ...
    <td id="stat"><?php echo $row['status'];?> 
  </tr>
...
function selected(value,id) { 
  ...
  let url = "http://localhost/EMS/php/adminleave.php";
